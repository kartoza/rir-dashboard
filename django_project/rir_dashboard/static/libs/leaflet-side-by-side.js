...
L.Control.SideBySide = L.Control.extend({
  ...
  _updateClip: function () {
    ...
    if (this._leftLayer) {
      $(`#${this._leftLayer.options.paneID}-text`).css('left', (dividerX - ($(`#${this._leftLayer.options.paneID}-text`).width()+10))+'px');
      $(`#${this._leftLayer.options.paneID}-text`).show();
      this._leftLayer.getPane().style.clip = clipLeft
    }
    if (this._rightLayer) {
      $(`#${this._rightLayer.options.paneID}-text`).css('left', (dividerX + 10)+'px');
      $(`#${this._rightLayer.options.paneID}-text`).show();
