...
indicator_form_url = [
    url(r'^api-with-geography-and-date', HarvesterAPIWithGeographyAndDateView.as_view(), name='harvester-api-with-geography-and-date'),
]
dashboard_url = [
    url(r'^indicator/(?P<pk>\d+)/harvester/', include(indicator_form_url)),
